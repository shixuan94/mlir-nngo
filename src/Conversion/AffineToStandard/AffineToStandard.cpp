...
/// the results.
Value nngo::lowerAffineUpperBound(mlir::AffineForOp op, mlir::OpBuilder &builder) {
...
/// the results.
Value nngo::lowerAffineLowerBound(mlir::AffineForOp op, mlir::OpBuilder &builder) {
...
public:
  ...
  LogicalResult matchAndRewrite(AffineForOp op,
    ...
    Value lowerBound = nngo::lowerAffineLowerBound(op, rewriter);
    Value upperBound = nngo::lowerAffineUpperBound(op, rewriter);
...
void nngo::populateAffineToVectorConversionPatterns(
...
class LowerAffinePass : public ConvertAffineToStandardBase<LowerAffinePass> {
  void runOnOperation() override {
    ...
    nngo::populateAffineToStdConversionPatterns(patterns);
    nngo::populateAffineToVectorConversionPatterns(patterns);
...
/// equivalent blocks.
std::unique_ptr<Pass> nngo::createLowerAffinePass() {
